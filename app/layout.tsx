...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      <body
        className={`${inter.className} bg-violet-50 text-stone-950 pt-28 sm:pt-36`}
      >
        <div className="bg-[#95b8d1] absolute top-[-6rem] -z-10 right-[11rem] h-[31.25rem] w-[31.25rem] rounded-full blur-[10rem] sm:w-[86.75rem]"></div>
